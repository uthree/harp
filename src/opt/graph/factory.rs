...
/// use harp::opt::graph::factory::create_ast_loop_suggester;
///
...
impl MultiPhaseConfig {
    ...
    /// # Example
    /// ```ignore
    /// use harp::opt::graph::factory::{MultiPhaseConfig, SubgraphMode};
    ///
    /// // サブグラフを個別カーネルとして生成
    ...
    /// # Example
    /// ```ignore
    /// use harp::opt::graph::factory::MultiPhaseConfig;
    ///
    /// // 幅4と幅8のSIMD候補を生成
    /// let config = MultiPhaseConfig::new()
...
/// # Example
/// ```ignore
/// use harp::opt::graph::factory::{create_multi_phase_optimizer, MultiPhaseConfig};
...
/// # Example
/// ```ignore
/// use harp::opt::graph::factory::{create_multi_phase_optimizer_with_selector, MultiPhaseConfig};
...
/// # Example
/// ```ignore
/// use harp::opt::graph::factory::{optimize_graph_multi_phase, MultiPhaseConfig};
///
/// let config = MultiPhaseConfig::new()
///     .with_beam_width(8)
///     .with_progress(true);
...
/// # Example
/// ```ignore
/// use harp::opt::graph::factory::optimize_graph_greedy;
///
