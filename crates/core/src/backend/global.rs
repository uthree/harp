...
//! # Example
//! ```ignore
//! use harp_core::backend::global::{set_default_device, get_default_device_kind, with_device, DeviceKind};
//! use harp_core::backend::metal::MetalDevice;
//!
...
/// # Example
/// ```ignore
/// use harp_core::backend::global::{set_default_device, DeviceKind};
/// use harp_core::backend::metal::MetalDevice;
///
/// let device = MetalDevice::new()?;
...
/// # Example
/// ```ignore
/// use harp_core::backend::{HarpDevice, set_device};
///
...
/// # Example
/// ```ignore
/// use harp_core::backend::set_device_str;
///
...
/// # Example
/// ```ignore
/// use harp_core::backend::global::{with_device, DeviceKind};
///
