    ...
    Sel: GraphSelector,
{
    ...
    ///
    /// ```ignore
    /// use harp_core::opt::{GraphRuntimeSelector, BeamSearchGraphOptimizer};
    /// use harp_core::backend::opencl::{OpenCLRenderer, OpenCLCompiler};
    ///
...
///
/// ```
/// use harp_core::opt::graph::{GreedyGraphOptimizer, GraphOptimizer, SubgraphInliningSuggester};
...
///
/// ```
/// use harp_core::opt::graph::{ChainedGraphOptimizer, GraphOptimizer};
